...
# 2020-11-25 v01 Cedar Grove Studios
...
# Set maximum (full-scale) display range (grams)
MAX_GR = 150
MIN_GR = ((MAX_GR // 5 ) * -1)
...
CALIB_RATIO = 2.268 / 4890  # load cell serial# 4540-01
...
clue.pixel[0] = (16, 16, 0)  # Set status indicator to yellow during load cell initialization
print('---------')
print('enable the NAU7802 chip:   ', nau7802.enable(True))
nau7802.channel = 1
nau7802.gain = 128

def zero_scale():
    # Initiate internal calibration; return raw zero offset value
    print('calibrate.INTERNAL:', nau7802.calibrate('INTERNAL'))
    print('calibrate.OFFSET:  ', nau7802.calibrate('OFFSET'))  # No weight on load cell
...
zero = zero_scale()                   # Get raw zero offset value
...
while True:
    ...
    if clue.button_a:
        # Store tare value; hold > 1 second to clear tare value
